// Renderizado de la lista de canciones y formularios
export function renderSongList(songs) {
  ...
  container.innerHTML = `
    ...
    <div class="grid gap-2">
      ${songs.map(s => `
        <div class="song-list-item p-3 bg-gray-800 rounded cursor-pointer flex justify-between items-center" data-id="${s.id}">
  ...
  `;
  // Event listeners se asignan en app.js
}
